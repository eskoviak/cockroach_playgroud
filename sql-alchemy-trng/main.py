...
if __name__ == '__main__':
    ...
    try:
        ...
        psycopg_uri = url = 'cockroachdb://ed:Kh4V3R9B7DcygecH@free-tier.gcp-us-central1.cockroachlabs.cloud:26257/bank?sslmode=verify-full&sslrootcert=..\\.postgresql\\root.crt&options=--cluster%3Dgolden-dingo-2123'
